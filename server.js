...
// GET Blog page: Show all posts (joined with user info)
...
// POST Edit a post (only allow if post belongs to the logged-in user)
...
// POST Delete a post (only allow if post belongs to the logged-in user)
...
// GET Logout: Destroy session and return to login page
